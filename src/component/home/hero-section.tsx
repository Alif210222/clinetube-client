...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-72 h-72 bg-cyan-500/5 blur-[120px] rounded-full" />
      ...
      <div className="container mx-auto px-4 pt-16 pb-24 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-pink-500/30 bg-white/10 dark:bg-white/5 backdrop-blur-md mb-6 no-underline">
            <TrendingUp className="w-4 h-4 text-pink-800 dark:text-pink-400" />
          ...
          <h1 className="text-5xl md:text-6xl xl:text-6xl font-bold leading-tight no-underline text-slate-900 dark:text-white">
            Stream.
            <span className="block bg-gradient-to-r from-pink-800 via-purple-600 to-cyan-500 text-transparent bg-clip-text">
              Review.
            </span>
            Discover Greatness.
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link href="/movies" className="no-underline">
              <Button className="h-12 px-7 text-base bg-gradient-to-r from-pink-700 to-purple-600 hover:opacity-80 cursor-pointer shadow-lg shadow-pink-500/20">
                Explore Now
              </Button>
            </Link>
        ...
        <div className="relative z-10 flex justify-center">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-pink-500/5 to-cyan-500/20 blur-2xl rounded-[30px]" />
